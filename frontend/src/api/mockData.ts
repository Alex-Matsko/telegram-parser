...
export const mockSources: Source[] = [
  { id: 1, type: 'channel', telegram_id: -1001234567890, source_name: 'Apple Price Moscow',   supplier_id: 1, is_active: true,  poll_interval_minutes: 15, parsing_strategy: 'auto',  bot_scenario_id: null, last_read_at: h(0.5), last_message_id: 45230, error_count: 0,  last_error: null,                              created_at: '2026-03-01T10:00:00Z', updated_at: h(0.5) },
  { id: 2, type: 'channel', telegram_id: -1001234567891, source_name: 'iStore Прайс',        supplier_id: 2, is_active: true,  poll_interval_minutes: 30, parsing_strategy: 'regex', bot_scenario_id: null, last_read_at: h(1),   last_message_id: 12450, error_count: 2,  last_error: 'FloodWaitError: 30 seconds',       created_at: '2026-03-01T12:00:00Z', updated_at: h(1)   },
  { id: 3, type: 'group',   telegram_id: -1001234567892, source_name: 'Гаджеты оптом',      supplier_id: 3, is_active: true,  poll_interval_minutes: 30, parsing_strategy: 'auto',  bot_scenario_id: null, last_read_at: h(2),   last_message_id: 87652, error_count: 0,  last_error: null,                              created_at: '2026-03-02T10:00:00Z', updated_at: h(2)   },
  { id: 4, type: 'bot',     telegram_id:  1234567893,    source_name: 'ТехноМаркет Бот',    supplier_id: 4, is_active: true,  poll_interval_minutes: 60, parsing_strategy: 'llm',   bot_scenario_id: 1,    last_read_at: h(3),   last_message_id: 334,   error_count: 0,  last_error: null,                              created_at: '2026-03-02T14:00:00Z', updated_at: h(3)   },
  { id: 5, type: 'channel', telegram_id: -1001234567894, source_name: 'Digital Zone Prices', supplier_id: 5, is_active: true,  poll_interval_minutes: 15, parsing_strategy: 'regex', bot_scenario_id: null, last_read_at: h(0.3), last_message_id: 67890, error_count: 0,  last_error: null,                              created_at: '2026-03-03T10:00:00Z', updated_at: h(0.3) },
  { id: 6, type: 'channel', telegram_id: -1001234567895, source_name: 'МСК Apple Цены',    supplier_id: 6, is_active: true,  poll_interval_minutes: 30, parsing_strategy: 'auto',  bot_scenario_id: null, last_read_at: h(4),   last_message_id: 23456, error_count: 5,  last_error: 'Connection timeout after 30s',    created_at: '2026-03-03T12:00:00Z', updated_at: h(4)   },
  { id: 7, type: 'bot',     telegram_id:  1234567896,    source_name: 'СПБ Прайс Бот',     supplier_id: 7, is_active: false, poll_interval_minutes: 60, parsing_strategy: 'auto',  bot_scenario_id: 2,    last_read_at: '2026-03-15T10:00:00Z', last_message_id: 112, error_count: 12, last_error: 'Bot blocked by user',             created_at: '2026-03-04T10:00:00Z', updated_at: '2026-03-15T10:00:00Z' },
  { id: 8, type: 'group',   telegram_id: -1001234567897, source_name: 'Apple Trade Group',   supplier_id: null, is_active: true, poll_interval_minutes: 45, parsing_strategy: 'llm', bot_scenario_id: null, last_read_at: h(1.5), last_message_id: 99123, error_count: 1, last_error: 'Rate limit reached, retrying in 60s', created_at: '2026-03-05T10:00:00Z', updated_at: h(1.5) },
];
...
export function mockGetUnresolved(filters: { status?: string; page?: number; per_page?: number }): UnresolvedResponse {
  ...
  return { items: items.slice((page - 1) * perPage, page * perPage), total: items.length, page, per_page: perPage };
}
